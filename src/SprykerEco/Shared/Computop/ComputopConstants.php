...
interface ComputopConstants
{
    ...
    const COMPUTOP_CREDIT_CARD_REVERSE_ACTION = 'COMPUTOP_CREDIT_CARD_REVERSE_ACTION';
    const COMPUTOP_CREDIT_CARD_INQUIRE_ACTION = 'COMPUTOP_CREDIT_CARD_INQUIRE_ACTION';
    const COMPUTOP_CREDIT_CARD_REFUND_ACTION = 'COMPUTOP_CREDIT_CARD_REFUND_ACTION';

    const COMPUTOP_TEST_ENABLED = 'COMPUTOP_TEST_ENABLED';
    const COMPUTOP_REFUND_SHIPMENT_PRICE_ENABLED = 'COMPUTOP_REFUND_SHIPMENT_PRICE_ENABLED';
