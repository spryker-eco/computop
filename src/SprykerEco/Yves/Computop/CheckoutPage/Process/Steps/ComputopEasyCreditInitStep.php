...
class ComputopEasyCreditInitStep extends AbstractBaseStep implements StepWithExternalRedirectInterface
{
    ...
    {
        if (!$quoteTransfer->getPayment() || $quoteTransfer->getPayment()->getPaymentSelection() !== ComputopConfig::PAYMENT_METHOD_EASY_CREDIT) {
            return $quoteTransfer;
        }

        $this->redirectUrl = $quoteTransfer->getPaymentOrFail()->getComputopEasyCreditOrFail()->getUrlOrFail();
